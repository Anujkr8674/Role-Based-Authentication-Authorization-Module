<header class="topbar">
    ...
    <div class="profile-menu">
        ...
        <div class="dropdown">
            <a href="employee-dashboard.php"><i class="fa-solid fa-circle-user"></i><span>View Profile</span></a>
            <a class="logout" href="employee-logout.php"><i class="fa-solid fa-right-from-bracket"></i><span>Logout</span></a>
        </div>
    </div>
</header>
